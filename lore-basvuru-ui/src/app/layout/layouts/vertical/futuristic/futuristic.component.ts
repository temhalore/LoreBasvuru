...
export class FuturisticLayoutComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this._authService.currentUser$.pipe(takeUntil(this._unsubscribeAll)).subscribe((loginResponse: LoginResponseModel) => { this.user = loginResponse.kisiTokenDto.kisiDto; });
