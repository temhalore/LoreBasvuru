...
@Component({
    ...
    styles: [`
            ...
            .ek-dense-full { display: none; }
            .fuse-vertical-navigation-hover .ek-dense-full,
            .fuse-vertical-navigation-appearance-default .ek-dense-full { display: inline; }
            .fuse-vertical-navigation-hover .ek-dense-tiny,
            .fuse-vertical-navigation-appearance-default .ek-dense-tiny { display: none; }
        `],
    imports: [
...
export class DenseLayoutComponent implements OnInit, OnDestroy {
    ...
    get selectedEtikKurulTinyName(): string {
    ...
    private resolveOnlyBasvurucuRole(roleList: any[], userTypes: string[]): boolean {
        ...
        return t.some((x) => x.includes('basvur') || x.includes('baÅŸvur')) && !t.some((x) => x.includes('sekreter') || x.includes('baskan') || x.includes('baÅŸkan') || x.includes('raportor') || x.includes('raportÃ¶r') || x.includes('uye') || x.includes('Ã¼ye') || x.includes('admin'));
    }
    ...
    private resolveThemeByEtikKurulName(name: string): string {
        ...
        if (n.includes('sosyal ve beÅŸeri bilimler araÅŸtÄ±rma etik kurulu')) return 'theme-default';
        if (n.includes('sucul omurgalÄ± canlÄ± deneyleri yerel etik kurulu')) return 'theme-brand';
