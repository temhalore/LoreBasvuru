...
@Component({
    ...
    styles: [`
            ...
            .ek-theme-wordmark { transition: filter 180ms ease; }
            .ek-theme-wordmark-default { filter: hue-rotate(28deg) saturate(1.2) brightness(0.9); }
            .ek-theme-wordmark-teal { filter: hue-rotate(0deg) saturate(1) brightness(1); }
            .ek-theme-wordmark-brand { filter: hue-rotate(95deg) saturate(1.45) brightness(1.02); }
...
export class MaterialLayoutComponent implements OnInit, OnDestroy {
    ...
    get wordmarkThemeClass(): string {
        switch (this.config?.theme) {
            case 'theme-brand': return 'ek-theme-wordmark ek-theme-wordmark-brand';
            case 'theme-teal': return 'ek-theme-wordmark ek-theme-wordmark-teal';
            default: return 'ek-theme-wordmark ek-theme-wordmark-default';
        }
    }
