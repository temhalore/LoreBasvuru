...
export class EnterpriseLayoutComponent implements OnInit, OnDestroy {
    ...
    private refreshCurrentRoute(): void {
        ...
        const previousShouldReuseRoute = this._router.routeReuseStrategy.shouldReuseRoute;
        ...
        this._router.navigateByUrl(currentUrl).finally(() => {
            this._router.routeReuseStrategy.shouldReuseRoute = previousShouldReuseRoute;
