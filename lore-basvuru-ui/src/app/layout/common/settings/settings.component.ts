...
export class SettingsComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this._fuseConfigService.config$
            ...
            .subscribe((config: FuseConfig) => {
                ...
                // Extract headerButtons from config
                if (config.headerButtons) {
                    this.headerButtons = { ...config.headerButtons };
                }
            });
    }
    ...
    setLayout(layout: string): void {
        ...
        LocalStorageService.setSelectedLayout(layout);

        // Drawer'ı kapat
        this._fuseDrawerService.getComponent('settingsDrawer')?.close();
    ...
    setScheme(scheme: Scheme): void {
        LocalStorageService.setSelectedScheme(scheme);
     ...
     * @param value
     */
    toggleHeaderButton(buttonName: string, value: boolean): void {
        const headerButtons = { 
            ...this.config.headerButtons,
            [buttonName]: value 
        };
        this._fuseConfigService.config = { headerButtons };
    }
}
